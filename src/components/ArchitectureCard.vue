<template>
  <div :id="data.postLocation" @click="recordDragEnd" :class="{ expanded: postVisible }" class="item architecture-item">
    <div class="item-content drop-shadow architecture architecture-card bg-white">
